...
import CollegeProfileClient, { type InitialData } from './CollegeProfileClient';
...
export default async function Page() {
  const initialProfile = await serverGet<InitialData>('/college/profile');

  return (
    <CollegeProfileClient initialProfile={initialProfile} />
  );
}
