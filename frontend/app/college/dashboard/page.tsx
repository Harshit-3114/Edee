...
import CollegeDashboardClient, { type InitialData } from './CollegeDashboardClient';
...
export default async function Page() {
  const initialSummary = await serverGet<InitialData>('/college/dashboard');

  return (
    <CollegeDashboardClient initialSummary={initialSummary} />
  );
}
