...
import CoachingInviteClient, { type InitialData } from './CoachingInviteClient';
...
export default async function Page() {
  const initialInvites = await serverGet<InitialData>('/coaching/invites');

  return (
    <CoachingInviteClient initialInvites={initialInvites} />
  );
}
