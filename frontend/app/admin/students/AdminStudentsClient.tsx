 ...
 *
 * `initialStudents` is the unfiltered list the server already fetched with the session
...
export default function AdminStudentsClient({
  ...
  initialStudents: AdminStudentRow[] | null;
}) {
...
export type InitialData = AdminStudentRow[];
