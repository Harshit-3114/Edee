 ...
 *
 * `initialColleges` is whatever the server already fetched with the session cookie:
 ...
 */
export default function AdminCollegesClient({
  initialColleges,
}: {
...
export type InitialData = College[];
