...
import AdminCollegesClient, { type InitialData } from './AdminCollegesClient';
...
export default async function Page() {
  const initialColleges = await serverGet<InitialData>('/admin/colleges');

  return (
    <AdminCollegesClient initialColleges={initialColleges} />
  );
}
