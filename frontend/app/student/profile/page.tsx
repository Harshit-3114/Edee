...
import StudentProfileClient, { type InitialData } from './StudentProfileClient';
...
export default async function Page() {
  const initialStudent = await serverGet<InitialData>('/students/me');

  return (
    <StudentProfileClient initialStudent={initialStudent} />
  );
}
